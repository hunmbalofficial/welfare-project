                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  ...
                  >
                    ...
                    <div className="flex gap-3">
                      <span className="px-3 py-1 rounded-full bg-primary-100 text-primary-700 text-xs font-medium backdrop-blur-sm border border-primary-600/30">Education</span>
                      <span className="px-3 py-1 rounded-full bg-primary-100 text-primary-700 text-xs font-medium backdrop-blur-sm border border-primary-600/30">Healthcare</span>
                      <span className="px-3 py-1 rounded-full bg-primary-100 text-primary-700 text-xs font-medium backdrop-blur-sm border border-primary-600/30">Community</span>
                    </div>
                  </motion.div>
                </div>
